...
export default function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (userExists) {
      ...
      localStorage.setItem('quantal_current_user', JSON.stringify(userExists));
      router.push('/dashboard/pricing');
    } else {
      setError('Aucun compte associé à cet email. Veuillez d\'abord vous inscrire.');
    }
  };
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-slate-950 font-sans">
      ...
      {/* Contenu principal centré avec la carte de connexion en verre dépoli */}
        ...
        <div className="backdrop-blur-xl bg-slate-900/60 border border-white/10 p-8 sm:p-10 rounded-3xl shadow-2xl text-white">
          ...
          <div className="text-center mb-8">
            <h2 className="text-3xl font-extrabold tracking-tight text-white">
              Bonjour !<br />Heureux de vous revoir
            </h2>
          </div>
